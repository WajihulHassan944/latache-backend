...
const ARABIC_TEMPLATES: Record<string, LocalizedTemplate> = {
  ...
  booking_payment_refunded: { title: 'تم استرداد الدفعة', body: 'وصلت دفعتك بعد إلغاء الحجز، لذلك يتم استردادها إلى بطاقتك.' },
...
const DARIJA_TEMPLATES: Record<string, LocalizedTemplate> = {
  ...
  booking_payment_refunded: { title: 'الفلوس ترجعات', body: 'الخلصة ديالك وصلات من بعد ما تلغى الحجز، داكشي علاش غادي ترجع لكارطتك.' },
